  ...
  <head>
    ...
    <div class="card-deck bg-white">
        <div class="card text-secondary bg-light mb-3 shadow mx-auto">
    ...
    <div class="container-fluid data mx-auto p-0 mx-4" style="margin-top: 80px;" >
        <!--p-0 float-left-->
        <div class="col container px-3 pt-3 pb-1 bg-light text-secondary rounded shadow">
